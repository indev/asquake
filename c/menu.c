...
void M_Main_Draw(void)
{
    ...
    M_DrawTransPic(54, 32 + m_main_cursor * 20,
		   M_CachePic(va("gfx/menudot%i.lmp", f + 1)));
}
...
void M_Menu_SerialConfig_f(void)
{
    ...
    (*GetComPortConfig) (0, &port, &serialConfig_irq, &baudrate,
			 &useModem);
...
void M_ModemConfig_Draw(void)
{
    ...
    M_Print(basex + 8, modemConfig_cursor_table[1] + 12,
	    modemConfig_clear);
    ...
    M_Print(basex + 8, modemConfig_cursor_table[3] + 12,
	    modemConfig_hangup);
    ...
    M_DrawCharacter(basex - 8,
		    modemConfig_cursor_table[modemConfig_cursor],
		    12 + ((int) (realtime * 4) & 1));
}
