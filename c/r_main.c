...
void R_ViewChanged(vrect_t * pvrect, int lineadj, float aspect)
{
    ...
    r_refdef.vrect_x_adj_shift20 =
	(r_refdef.vrect.x << 20) + (1 << 19) - 1;
...
// bottom side clip
    ...
    screenedge[3].normal[1] =
	1.0 / ((1.0 - yOrigin) * verticalFieldOfView);
...
void R_RenderView(void)
{
	...
	//Sys_Error("R_RenderView: called without enough stack (%d)", delta);
	Sys_Printf("R_RenderView: called without enough stack (%d)", delta);
